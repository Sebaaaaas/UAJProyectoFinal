...
//le da valores a la ventana y se asegura de que los mensajes están funcionando correctamente
void ImGuiWindow(const HWND& window) {
...
INT APIENTRY WinMain(HINSTANCE instance, HINSTANCE, PSTR, INT cmd_show) {
	...
	while (running) {
		...
		RenderBotones(windowWidth, windowHeight, buttons, joycheckboxes, saveSlots, mapper, simulator, conv, detectedKey, checkL, checkR);
